...
import DeleteDosenModal from "./modal/delete";
import CreateDosenModal from "./modal/create";
import EditDosenModal from "./modal/edit";
  ...
  return (
    <div className="container py-10">
      <DataTable
        ...
        // MODAL
        modals={{
          add: () => <CreateDosenModal />,
          edit: (dosen) => (dosen ? <EditDosenModal data={dosen} /> : null),
          delete: (dosen) => (dosen ? <DeleteDosenModal data={dosen} /> : null),
        }}
      />
    </div>
  );
